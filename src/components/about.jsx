                    ...
                    <div className="col-lg-6">
                      <ul>
                        <li>
                          ...
                          <strong>Name:</strong> <span>Letitia Abigail</span>
                        </li>
                        <li>
                          <i className="bi bi-chevron-right" />{" "}
                          <strong>Website:</strong> <span>letitia.net</span>
                        </li>
                        <li>
                          <i className="bi bi-chevron-right" />{" "}
                          <strong>City:</strong> <span>Sulawesi Utara, Kab. Minahasa, Kec. Tondano Barat, Kel.Wawalintouan</span>
                        </li>
                      </ul>
                    </div>
                    <div className="col-lg-6">
                      <ul>
                        ...
                        <li>
                          <i className="bi bi-chevron-right" />{" "}
                          <strong>Freelance:</strong> <span>Video Editor</span>
                        </li>
                      </ul>
                    </div>
                  </div>
